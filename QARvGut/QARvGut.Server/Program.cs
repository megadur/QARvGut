...
using QARvGut.Server.Authorization.Requirements;
using QARvGut.Server.Configuration;
using QARvGut.Server.Services;
using QARvGut.Server.Services.Email;
using Quartz;
    ...
    public partial class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            if (app.Environment.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.DocumentTitle = "Swagger UI - QARvGut";
